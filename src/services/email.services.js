...
async function sendRegistrationEmail(userEmail, name) {
    ...
    const html = `<p>Hello ${name},</p><p>Thank you for registering at Backend Ledger. We are excited to have you on board.</p>`;
...
async function sendTransactionEmail(userEmail, name, amount, type) {
    ...
    const text = `Hello ${name},\n\nYour transaction of ${amount} ${type} has been processed.`;
    const html = `<p>Hello ${name},</p><p>Your transaction of ${amount} ${type} has been processed.</p>`;
